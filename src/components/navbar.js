            ...
            <div className="w-[70%]  bg-black h-[60px] border flex rounded-full ml-[15%] text-white text-l mt-8">
                <div className="flex lg:w-[40%] mobile:w-[15%] justify-between mt-2">
                    ...
                    <div
                        ...
                        } hover:bg-black ml-3  lg:h-10 lg:w-24 mobile:h-7 mobile:mt-2 lg:mt-0 mobile:pt-0 lg:pt-1.5  rounded-2xl pl-3 mobile:pl-2 lg:pr-0 mobile:pr-2 `}
                        onMouseEnter={handleHover}
                        onMouseLeave={handleLeave}
                    > <MdHomeFilled className="mt-1"/>
                        <p className="lg:flex mobile:hidden"> Home</p>
                    </div>
                    <div
                        className="bg-black hover:bg-rose-400 ml-3 h-10 w-24 pt-1.5 rounded-2xl pl-3 lg:flex mobile:hidden"
                        onMouseEnter={handleHover}
                        onMouseLeave={handleLeave}
                    >
                    ...
                    <div
                        className="bg-black hover:bg-rose-400 ml-3 lg:h-10 mobile:h-8 mobile:mt-1 lg:mt-0 mobile:pt-1 w-24  lg:pt-1.5 rounded-2xl pl-3 pr-2 flex"
                        onMouseEnter={handleHover}
                        onMouseLeave={handleLeave}
                    >
                ...
                <div className="flex w-[40%] justify-around mt-2">
                    <div
                        className="bg-black hover:bg-rose-400 ml-3 lg:h-10 mobile:h-8 mobile:mt-1 lg:mt-0 mobile:pt-1 w-24  lg:pt-1.5 rounded-2xl pl-3 mobile:pr-2 lg:pr-0 flex"
                        onMouseEnter={handleHover}
                        onMouseLeave={handleLeave}
                    ><RxResume className="mt-1 mr-1"/>
                        <p className="lg:flex mobile:hidden"> Resume</p>
                    </div>
                    <div
                        className="bg-black hover:bg-rose-400 ml-3 lg:h-10 mobile:h-8 mobile:mt-1 lg:mt-0 mobile:pt-1 w-24  lg:pt-1.5 rounded-2xl pl-3 mobile:pr-2 lg:pr-0 flex"
                        onMouseEnter={handleHover}
                    ...
                    <div
                        className="bg-black hover:bg-rose-400 ml-3 h-10 w-24 pt-1.5 rounded-2xl pl-5 lg:flex mobile:hidden"
                        onMouseEnter={handleHover}
                        onMouseLeave={handleLeave}
