            ...
            <div className="w-[80vw] h-[60vh] font-semibold lg:mt-[4%] mobile:mt-[18%] grid grid-rows-3  gap-5 ">
                <div className='ml-[10%]   lg:bg-gray-100 mobile:bg-gray-200 lg:flex mobile:inline gap-6 mobile:w-[110%] lg:w-[100%] mobile:h-[105%] lg:h-[100%] '>
                    <div className="mobile:ml-4 lg:ml-0 ">
                       <div className="lg:text-3xl  mobile:text-xl mobile:mt-4 lg:mt-0 ">
                           DIET IEEE SB, Visakhapatnam
                       </div>
                        <div className="lg:text-2xl  mobile:text-xl text-gray-600 ">
                            July 2023 - present
                        </div>
                    </div>
                    <div className="rounded-full border-dotted border-2 mobile:hidden lg:flex border-black h-[48px] ml-[19%] mr-[200px] w-[48px]">
                ...
                <div className='ml-[10%] lg:flex mobile:inlinegap-6 mobile:h-[140%]  lg:h-[50px]  lg:bg-gray-100 mobile:bg-gray-200   w-[110%] lg:mt-8 mobile:mt-0'>
                    <div className="mobile:ml-4 lg:ml-0  ">
                        <div className="lg:text-3xl  mobile:text-xl  ">
                               IEEE Xtreme
                        </div>
                    ...
                    <div className="rounded-full mobile:hidden lg:flex border-dotted border-2 border-black ml-[250px] mr-[-40px]  h-[48px] w-[48px] ">
                        <div className=" bg-black lg:h-[36px]  w-[36px] border rounded-full ml-1 mt-1  "></div>
                    </div>
                    <div className="w-[40px]  lg:ml-[18%] mobile:ml-5 ">
                        <div className="lg:text-3xl mobile:text-xl  ">
                           Student Ambassador
                        </div>
                        <div className="text-xl text-gray-600  mobile:w-[310px] lg:w-[400px] ">
                            Selected as an Student ambassador for IEEE Xtreme 24 hours coding competition
                        </div>
                    </div>
                </div>


                <div className='ml-[10%]  lg:bg-gray-100 mobile:bg-gray-200 mt-14  lg:flex gap-6 mobile:inline  lg:w-[100%] lg:h-[100%] mobile:h-[125%]  mobile:w-[110%]'>
                    <div className=" lg:mt-0 mobile:ml-4 lg:ml-0  mobile:mt-0">
                        <div className="lg:text-3xl mobile:text-xl   ">
                            Bharath Intern
                        </div>
                        <div className="text-2xl text-gray-600 ">
                    ...
                    <div className="lg:ml-[20%]  mobile:ml-[33px] relative right-8 ">
                        <div className="lg:text-3xl mobile:ml-4 lg:ml-0  mobile:text-2xl  ">
                           Intern
                        </div>
                        <div className="text-xl mobile:ml-4 lg:ml-0  text-gray-600 ">
