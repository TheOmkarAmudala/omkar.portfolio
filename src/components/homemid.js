...
function Hoemid(){
    ...
    return (
        ...
        <div className="flex flex-col align-middle mobile:w-[20vw] lg:w-[100vw] font-urbanist font-bold mobile:h-[60vh] lg:h-[110vh] w-[100vw] mobile:mt-[20vh] lg:mt-[0] mobile:overscroll-x-none mobile:ml-[0%] lg:ml-[0%] ">

            <div className="border-2 lg:ml-[45%] lg:w-[165px]  mobile:ml-[25vw] lg:text-[30px] mobile:text-[40px] mobile:mb-[50px] mobile:h-[70vh] mobile:w-[180px] mobile:pl-[45px]  border-gray-700  h-14 pt-0.5  mt-10 w-[140px] pl-8 rounded-full ">Hello</div>
            <TypeAnimation
            ...
            <div className="flex justify-between mobile:w-[100vw] lg:[10%] ">
                ...
                <div className={`image ${loaded ? '' : 'hidden'}`}><img src={photo}  className=" lg:w-[800px] mobile:mt-[0%] lg:mt-[0] lg:h-700 mobile:ml-[0vw] mobile:w-[100%] lg:ml-0 relative lg:bottom-[120px] sm:bottom-0"  /></div>
