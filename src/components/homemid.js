...
function Hoemid(){
    ...
    return (
        ...
        <div
            className="flex flex-col align-middle mobile:w-[20vw] lg:w-[100vw] font-urbanist font-bold mobile:h-[60vh] lg:h-[110vh] w-[100vw] mobile:mt-[10vh] lg:mt-[0] mobile:overscroll-x-none mobile:ml-[0%] lg:ml-[0%] ">
            ...
            <div className="flex justify-between mobile:w-[100vw] lg:[10%] ">
                ...
                <div className={`image ${loaded ? '' : 'hidden'}`}><img src={photo}
                                                                        className=" lg:w-[800px] mobile:mt-[0%] lg:mt-[0] lg:h-700 mobile:ml-[0vw] mobile:w-[100%] lg:ml-0 relative lg:bottom-[120px] sm:bottom-0"/>
                </div>
